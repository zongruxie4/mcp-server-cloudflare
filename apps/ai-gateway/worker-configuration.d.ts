/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 235b0cf18676bc13d95c9f1d22cede3a)
// Runtime types generated with workerd@1.20260529.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_METRICS: AnalyticsEngineDataset;
	ENVIRONMENT: "staging" | "production" | "development";
	MCP_SERVER_NAME: "Cloudflare AI Gateway Remote MCP Server - Staging" | "Cloudflare AI gateway Remote MCP Server" | "<PLACEHOLDER>";
	MCP_SERVER_VERSION: "1.0.0" | "<PLACEHOLDER>";
	MCP_OBJECT: DurableObjectNamespace<import("./src/ai-gateway.app").AIGatewayMCP>;
	CLOUDFLARE_CLIENT_ID?: "<PLACEHOLDER>";
	CLOUDFLARE_CLIENT_SECRET?: "<PLACEHOLDER>";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/ai-gateway.app");
		durableNamespaces: "AIGatewayMCP";
	}
