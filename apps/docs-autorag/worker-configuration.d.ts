/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5072ed83c42db59de5b8013f2400f16f)
...
interface __BaseEnv_Env {
	...
	MCP_OBJECT: DurableObjectNamespace<import("./src/docs-autorag.app").CloudflareDocumentationMCP>;
