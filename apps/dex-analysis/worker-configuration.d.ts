/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31f87847035fe60e532e8972deab33a2)
// Runtime types generated with workerd@1.20260529.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_METRICS: AnalyticsEngineDataset;
	ENVIRONMENT: "staging" | "production" | "development";
	MCP_OBJECT: DurableObjectNamespace<import("./src/dex-analysis.app").CloudflareDEXMCP>;
	WARP_DIAG_READER: DurableObjectNamespace<import("./src/dex-analysis.app").WarpDiagReader>;
	MCP_SERVER_NAME?: "PLACEHOLDER";
	MCP_SERVER_VERSION?: "PLACEHOLDER";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/dex-analysis.app");
		durableNamespaces: "CloudflareDEXMCP" | "WarpDiagReader";
	}
