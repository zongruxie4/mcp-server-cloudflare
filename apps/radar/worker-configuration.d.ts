/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e4c1d2d543cb983078cc3d3251c28b6)
// Runtime types generated with workerd@1.20260529.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_METRICS: AnalyticsEngineDataset;
	ENVIRONMENT: "staging" | "production" | "development";
	MCP_SERVER_NAME: "Cloudflare Radar Remote MCP Server - Staging" | "Cloudflare Radar Remote MCP Server" | "Cloudflare Radar Remote MCP Server - Dev";
	MCP_SERVER_VERSION: "1.0.0";
	MCP_OBJECT: DurableObjectNamespace<import("./src/radar.app").RadarMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/radar.app");
		durableNamespaces: "RadarMCP";
	}
