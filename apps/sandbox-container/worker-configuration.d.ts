/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e8b5eebe4613fcd8141b5395097dd05a)
...
interface __BaseEnv_Env {
	...
	MCP_OBJECT: DurableObjectNamespace<import("./server/sandbox.server.app").ContainerMcpAgent>;
	CONTAINER_MANAGER: DurableObjectNamespace<import("./server/sandbox.server.app").ContainerManager>;
	USER_CONTAINER: DurableObjectNamespace<import("./server/sandbox.server.app").UserContainer>;
	AI?: Ai;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/sandbox.server.app");
		durableNamespaces: "ContainerManager" | "ContainerMcpAgent" | "UserContainer";
	}
