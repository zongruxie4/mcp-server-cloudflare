/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0714ea798d0bf979ddc0aa7fbd96429a)
// Runtime types generated with workerd@1.20260529.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_METRICS: AnalyticsEngineDataset;
	ENVIRONMENT: "staging" | "production" | "development";
	MCP_SERVER_NAME: "logpush-staging" | "logpush" | "<PLACEHOLDER>";
	MCP_SERVER_VERSION: "1.0.0" | "<PLACEHOLDER>";
	MCP_OBJECT: DurableObjectNamespace<import("./src/logpush.app").LogsMCP>;
	CLOUDFLARE_CLIENT_ID?: "<PLACEHOLDER>";
	CLOUDFLARE_CLIENT_SECRET?: "<PLACEHOLDER>";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/logpush.app");
		durableNamespaces: "LogsMCP";
	}
