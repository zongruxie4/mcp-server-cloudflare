/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 772a47d701d1342546d2ead743623f84)
// Runtime types generated with workerd@1.20260529.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_METRICS: AnalyticsEngineDataset;
	ENVIRONMENT: "staging" | "production" | "development";
	MCP_SERVER_NAME: "Cloudflare AutoRAG Remote MCP Server - Staging" | "Cloudflare AutoRAG Remote MCP Server" | "<PLACEHOLDER>";
	MCP_SERVER_VERSION: "1.0.0" | "<PLACEHOLDER>";
	MCP_OBJECT: DurableObjectNamespace<import("./src/autorag.app").AutoRAGMCP>;
	CLOUDFLARE_CLIENT_ID?: "<PLACEHOLDER>";
	CLOUDFLARE_CLIENT_SECRET?: "<PLACEHOLDER>";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/autorag.app");
		durableNamespaces: "AutoRAGMCP";
	}
